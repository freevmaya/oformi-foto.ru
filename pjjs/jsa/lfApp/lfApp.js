...
var TMPLSOURCEURL = document.location.origin + '/games/data/' + (ISDEV?'index_dev.php':'index.php');
var STORAGEURL = document.location.origin + '/games/data/storage_lt.php';
...
var lfApp = new Class({
    ...
    help: function() {
        this.open(PROTOCOL + '://oformi-foto.ru/pjjs/help.php'); 
    },
    
    about: function() {
        this.open(PROTOCOL + '://oformi-foto.ru/pjjs/about.php'); 
    },
