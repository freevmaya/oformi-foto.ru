        ...
        switch (a_method) {
            ...
            case 'Href2':   clickImpl(function() {          
                                ...
                                var dispSave = (function() {
                                    ...
                                    yaCounter25946306.reachGoal('save');
            ...
            case 'imageWindow': clickImpl(function() {
                                    ...
                                    win.document.body.innerHTML = helpBlock + '<a href="' + a_data.replace(this.strMime, this.strDownloadMime) + '" download="download.jpg"><img type="' + 
