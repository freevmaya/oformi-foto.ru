...
<link href="styles/styles-left.css" rel="stylesheet" />
<link href="styles/styles-slider.css" rel="stylesheet" />

<script stype="text/javascript">var HOSTURL='<?=$hostURL;?>';var PROTOCOL='<?=$protocol?>';var VER='<?=$v?>'</script>
...
<script src="<?=$jaPath?>/pjApp/pjcanvas.<?=$jsExt?>" type="text/javascript"></script> 
<script src="<?=$jaPath?>/pjApp/baseapp.<?=$jsExt?>" type="text/javascript"></script>
<script src="<?=$jaPath?>/pjApp/leftPJApp.<?=$jsExt?>" type="text/javascript"></script>
...
<script src="<?=$jaPath?>/pjApp/baseTmplList.<?=$jsExt?>" type="text/javascript"></script>
...
<script src="<?=$jaPath?>/controls/click-panel.<?=$jsExt?>" type="text/javascript"></script>
