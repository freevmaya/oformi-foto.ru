OkClient = {
    ...
    call:function (params, userCallback, resig) {
        ...
        sig = this.calcSignature(params, this.sessionSecretKey);
        params["sig"] = sig;
        if (resig != null) {
            params["resig"] = resig;
        }
        ...
        this.load(this.apiServer + query + "access_token=" + this.accessToken + "&js_callback=" + callbackid);
        return callbackid;
    },
    fillParams:function (params) {
        params = params || {};
        params["application_key"] = this.applicationKey;
        params["session_key"] = this.accessToken;
    ...
    initialize:function (apiServer, params) {
        this.applicationKey = params["application_key"];
        this.sessionSecretKey = params["session_secret_key"];
        this.accessToken = params["access_token"];
        this.apiServer = apiServer + "fb.do";
