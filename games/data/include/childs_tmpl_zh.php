...
*/    
    ...
    $brand_groups = array(45, 47, 48, 49, 300, 301, 302, 303);
    $hide_group = array(41, 44, 45, 47, 48, 49, 71, 73, 122, 302, 303);
...
//            trace($query);
        ...
        protected function getCats_rus() {
            ...
            if (isset($newNames[$alang])) {
                $query = "SELECT COUNT(n.id) AS `count` FROM gpj_templates_new n INNER JOIN gpj_tmplOptions o ON o.tmpl_id=n.id WHERE o.lang='".strtolower($alang)."' OR o.lang='any' AND o.height > 0";
                $countData = DB::line($query);
