<?
    ...
    class pjf_m4 extends g_model {

        protected function userMailNotify($mail, $sid, $userName, $subject, $description) {
            GLOBAL $_SERVER;
            ob_start();
            require(MAINPATH.'games/templates/pj/_mail_mm.php');
        ...
        public function sendCardEmail($params) {
            ...
            $send_result = array();
            if ($send_result['state'] = sql_query("INSERT INTO gpj_send (`uid`, `sendTo`, `params`, `time`, `card_id`) 
