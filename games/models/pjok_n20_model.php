...
//    ERROR---        
    ...
    class pjok_n20 extends g_model {
...
/*        public function receiveCardViewed($params) {
        ...
        public function addRate($params) {
            ...
            $added = 0;
            if (!DB::one("SELECT tmpl_id FROM pjok_rateUsers WHERE tmpl_id={$params[0]} LIMIT 0,1")) $added = 1;
            
            DB::query("REPLACE pjok_rateUsers (`uid`, `tmpl_id`) VALUES ({$params[1]}, {$params[0]})");
            return array('result'=>1, 'added'=>$added);
        }
/*            
