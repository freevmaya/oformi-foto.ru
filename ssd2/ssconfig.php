...
//<!---FROM CATALOG
    define('FRAMES_PNGURL', 'https://oformi-foto.ru/png_tmp/%s.png');
    define('BASEHOST', 'oformi-foto.ru');
    define('BASEAPP_URL', MAINURL);
    define('BASESTORAGEURL', $sheme.'oformi-foto.ru');
    define('RESVSTORAGEURL', $sheme.'oformi-foto.ru');
...
//---FROM CATALOG-->
    ...
    define('TREEURL', '//oformi-foto.ru/tree/');
    define('GAMEPATH', MAINPATH.'images/game/');
    define('GAMEURL', $sheme.'oformi-foto.ru/images/game/');    
